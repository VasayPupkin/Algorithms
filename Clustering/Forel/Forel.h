...
using ClusteringMarkPair = std::pair<ObjCoord, bool>;
using ClusteringMarkList = std::list<ClusteringMarkPair>;
using ClusteringMarkVector = std::vector<ClusteringMarkPair>;
